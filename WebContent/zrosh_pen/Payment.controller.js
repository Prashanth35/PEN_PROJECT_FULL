sap.ui.controller("zrosh_pen.Payment", {

/**
* Called when a controller is instantiated and its View controls (if available) are already created.
* Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
* @memberOf zrosh_pen.Payment
*/
	onInit: function() {
	...
	/*	var oTemplate = new sap.m.GenericTile({
		...
		var oTemplate = new sap.m.StandardTile({
			...
			press:this.onPress
				...
				var oTile=this.getView().byId("idTileContainer");
				
		oTile.bindAggregation("tiles","/tileData",oTemplate);
